...
import { ReleaseStatusCellRendererComponent } from './release-status-cell-renderer.component';
...
describe('EditCellRendererComponent', () => {
  let component: ReleaseStatusCellRendererComponent;
  let spectator: Spectator<ReleaseStatusCellRendererComponent>;
