...
import {
  HARDMAGNET_COLUMN_DEFINITIONS,
  HARDMAGNET_MATERIAL_STANDARDS_COLUMN_DEFINITIONS,
  HARDMAGNET_SUPPLIERS_COLUMN_DEFINITIONS,
} from './hardmagnet';
import {
...
export const COLUMN_DEFINITIONS_MAPPING: MsdColumnDefinitionsMapping = {
  materials: {
    ...
    [MaterialClass.HARDMAGNET]: {
      [NavigationLevel.MATERIAL]: HARDMAGNET_COLUMN_DEFINITIONS,
      [NavigationLevel.SUPPLIER]: HARDMAGNET_SUPPLIERS_COLUMN_DEFINITIONS,
      [NavigationLevel.STANDARD]:
        HARDMAGNET_MATERIAL_STANDARDS_COLUMN_DEFINITIONS,
    },
