...
export const SAP_MATERIALS_COLUMN_DEFINITIONS: ColDef[] = [
  ...
  {
    field: DIRECT_SUPPLIER_EMISSIONS,
    headerName: DIRECT_SUPPLIER_EMISSIONS,
    filter: 'agNumberColumnFilter',
    filterParams: DIRECT_SUPPLIER_EMISSIONS,
    headerTooltip: 'co2perkg',
    hide: true,
  },
  {
    field: INDIRECT_SUPPLIER_EMISSIONS,
    headerName: INDIRECT_SUPPLIER_EMISSIONS,
    filter: 'agNumberColumnFilter',
    filterParams: INDIRECT_SUPPLIER_EMISSIONS,
    headerTooltip: 'co2perkg',
    hide: true,
  },
  {
    field: UPSTREAM_EMISSIONS,
    headerName: UPSTREAM_EMISSIONS,
    filter: 'agNumberColumnFilter',
    filterParams: UPSTREAM_EMISSIONS,
    headerTooltip: 'co2perkg',
    hide: true,
  },
  {
