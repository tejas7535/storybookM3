...
// Thermal results
export const STRING_OUTP_TEMPERATURES = 'STRING_OUTP_TEMPERATURES';

// thermal inputs
export const STRING_OUTP_SHAFT = 'STRING_OUTP_SHAFT';
export const FO_D = 'FO_D';
export const FU_D = 'FU_D';
