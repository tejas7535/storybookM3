...
import { FilterEventsForIterationsSectionPipe } from './components/approval-cockpit/approval-workflow-history/approval-workflow-history-iterations/pipes/filter-events-for-iterations-section.pipe';
...
@NgModule({
  ...
  declarations: [
    ...
    ApproverDisplayPipe,
    FilterEventsForIterationsSectionPipe,
  ],
  exports: [
    OverviewTabComponent,
    GeneralInformationComponent,
