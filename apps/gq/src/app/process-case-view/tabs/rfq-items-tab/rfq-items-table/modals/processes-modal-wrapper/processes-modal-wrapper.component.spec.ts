  ...
  describe('getTitle', () => {
    describe('OPEN Status', () => {
      test('should return title when calculator found', () => {
        ...
        expect(component.title).toBe(
          translate('shared.rfqItemsTable.approvalProcesses.start.title', {
            posId: '12345',
          })
        );
      });
    ...
    describe('SHOW_HISTORY Status', () => {
      test('should return title for SHOW_HISTORY', () => {
        ...
        expect(component.title).toBe(
          translate('shared.rfqItemsTable.approvalProcesses.history.title', {
            posId: '12345',
          })
        );
      });
    ...
    describe('CANCEL process', () => {
      test('should return title for CANCEL process', () => {
        ...
        expect(component.title).toBe(
          translate('shared.rfqItemsTable.approvalProcesses.cancel.title', {
            posId: '12345',
          })
        );
      });
