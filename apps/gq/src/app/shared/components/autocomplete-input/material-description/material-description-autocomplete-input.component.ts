...
@Component({
  selector: 'gq-material-description-autocomplete-input',
...
export class MaterialDescriptionAutoCompleteInputComponent extends BaseAutocompleteInputComponent {
  materialAutocompleteUtils = inject(MaterialAutocompleteUtilsService);

  constructor() {
    super(FilterNames.MATERIAL_DESCRIPTION);
  }
