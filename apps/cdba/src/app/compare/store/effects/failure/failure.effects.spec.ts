  ...
  describe('loadFailure$', () => {
    it(
      ...
      marbles((m) => {
        ...
        const loadComparisonSummaryFailureAction =
          loadComparisonSummaryFailure(forbiddenError);
        ...
        actions$ = m.hot('-a-b-c-d-e', {
          ...
          e: loadComparisonSummaryFailureAction,
        });
    ...
    it(
      ...
      marbles((m) => {
        ...
        const loadComparisonSummaryServerFailureAction =
          loadComparisonSummaryFailure(serverError);
        ...
        actions$ = m.hot('-a-b-c-d-e', {
          ...
          e: loadComparisonSummaryServerFailureAction,
        });
