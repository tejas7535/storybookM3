...
import { CompareCalculationsButtonComponent } from './compare-calculations-button.component';

describe('CompareCalculationsButtonComponent', () => {
  let spectator: Spectator<CompareCalculationsButtonComponent>;
  let component: CompareCalculationsButtonComponent;
  let router: Router;
  ...
  const createComponent = createComponentFactory({
    component: CompareCalculationsButtonComponent,
    imports: [
