...
export class GreaseReportService {
  ...
  public formatGreaseReport(subordinates: Subordinate[]): Subordinate[] {
              ...
              (tableItems: TableItem[], index: number) => {
                ...
                const greaseResult: GreaseResult = {
                  ...
                  dataSource: [
                    ...
                    this.greaseResultDataSourceService.supportForSeals(
                      tableItems
                    ),
                    this.greaseResultDataSourceService.h1Registration(
                      tableItems
                    ),
                  ],
                };
